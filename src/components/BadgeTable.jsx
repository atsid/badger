        ...
        <TableBody displayRowCheckbox={false}>
          {
            projects.map((p, i) => (
              <TableRow key={i}>
                ...
                <TableRowColumn
                  className="badgeTableCell"
                  dangerouslySetInnerHTML={{ __html: p.badges.build }}
                />
                <TableRowColumn
                  className="badgeTableCell"
                  dangerouslySetInnerHTML={{ __html: p.badges.quality }}
                />
                <TableRowColumn
                  className="badgeTableCell"
                  dangerouslySetInnerHTML={{ __html: p.badges.coverage }}
                />
                <TableRowColumn
                  className="badgeTableCell"
                  dangerouslySetInnerHTML={{ __html: p.badges.dependencies }}
                />
                <TableRowColumn
                  className="badgeTableCell"
                  dangerouslySetInnerHTML={{ __html: p.badges.devDependencies }}
                />
                <TableRowColumn>
                  <span className="languageCell">{p.language}</span>
                </TableRowColumn>
              </TableRow>
            ))
          }
